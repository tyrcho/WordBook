 ...
 * @author MDA.
 */
public class RadioButtonGroup extends JPanel implements IInputField,
		SwingConstants {
	...
	/**
	 * @param orientation
	 *            either VERTICAL or HORIZONTAL, used to layout buttons
	 * @param values
	 *            a map with keys=labels, values=the object to return
	 */
