...
public class SearchableList<T> extends JPanel {
	...
	public static void main(String[] args) {
		...
		SearchableList<String> panel = new SearchableList<String>(data,
				new RegexpFilter<String>() {
	...
	private class TypeSafeListModel<T> extends AbstractListModel {
		 ...
		 *                if the <code>index</code> is negative or greater than
		 ...
		 * <code>ArrayIndexOutOfBoundsException</code> if the index is negative
		 * or not less than the size of the list. <blockquote> <b>Note:</b>
		 * Although this method is not deprecated, the preferred method to use
		 * is <code>get(int)</code>, which implements the <code>List</code>
		...
		/**
		 * Sets the component at the specified <code>index</code> of this list
		 ...
		 * deprecated, the preferred method to use is
		 * <code>set(int,Object)</code>, which implements the <code>List</code>
		 * interface defined in the 1.2 Collections framework. </blockquote>
		 * 
		 * @param obj
		 ...
		 * invalid. <blockquote> <b>Note:</b> Although this method is not
		 * deprecated, the preferred method to use is
		 * <code>add(int,Object)</code>, which implements the <code>List</code>
		 * interface defined in the 1.2 Collections framework. </blockquote>
		 * 
		 * @param obj
