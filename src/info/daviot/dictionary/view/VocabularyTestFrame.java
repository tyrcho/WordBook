...
public class VocabularyTestFrame extends JFrame {
	...
	private void questionAnswered(String answer) {
		...
		DictionaryEntry dictionaryEntry = currentQuestion.dictionaryEntry();
		if (currentQuestion.isAnswerValid()) {
			...
			DictionaryEntry possibleConfusion = session
			...
			String score = dictionaryEntry.displayRating();
			String message = (translations > 1 ? "les traductions possible pour "
					: "la bonne traduction pour ")
