...
import com.tyrcho.gui.toolkit.Box;
...
public class ListEditorPanel<T> extends JPanel {
    ...
    public ListEditorPanel(List<T> elements, EditorPanel<T> editorPanel, RegexpFilter<T> filter) {
    ...
    private void init() {
        ...
        JSplitPane splitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, list, (Component) editorPanel);
        ...
        list.getList().addListSelectionListener(new ListSelectionListener() {
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    editCompleteListener.removeHimself();
                    Object lastSelectedValue = list.getList().getSelectedValue();
    ...
    private final class RemovableEditCompleteListener implements EditCompleteListener<T> {
    ...
    private static class StringEditorPanel extends DefaultEditorPanel<String> {
        ...
        public StringEditorPanel() {
            super(new DefaultInputFieldGroup(Collections.singletonMap("toto", new JTextField())));
    ...
    public static void main(String[] args) {
        ...
        ListEditorPanel<String> listEditor = new ListEditorPanel<String>(data, new StringEditorPanel(), new RegexpFilter<String>() {
